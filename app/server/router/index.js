...
import councilBriefsRouter from './council-briefs-router.js';
...
import artifactsRouter from './artifacts-router.js';
import runsRouter from './runs-router.js';
import workspacesRouter from './workspaces-router.js';
import connectorsRegistryRouter from './connectors-registry-router.js';
